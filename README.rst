...
- **highlight(code, lexername=None)**: Highlight some code with the given lexer (ie. language). You can omit it and it will try to guess from the source code but it may take cause performance issues
